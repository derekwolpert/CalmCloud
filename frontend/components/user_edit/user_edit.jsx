...
class UserEdit extends React.Component {
    ...
    componentDidMount() {
        ...
        } else if (this.props.currentUsername === null) {
            this.props.history.push("/");
        }

        document.title = "Profile Settings | CalmCloud";
    }

    componentDidUpdate(prevProps) {

        if ((this.props.currentUser === undefined && prevProps.currentUser) || (this.props.currentUsername === null)) {
            this.props.history.push("/");
        }
        if (!this.props.currentUser) {
            this.props.fetchUser(this.props.currentUsername);
                    ...
                    <div className="track-index-sidebar-inner-container">
                        ...
                        <nav>
                            <div className="track-index-sidebar-nav-group">
                                <Link to="/settings" className={`track-index-sidebar-nav-${this.props.match.path === "/settings" ? "active" : "inactive"}`} >
    ...
    handleBiography(e) {
        this.setState({
            biography: e.currentTarget.value
        });
    }
        ...
        return (
            this.state.stateIsSet && this.props.currentUser ?
                ...
                <section className="user-edit-container">
                    {this.sidebar()}
                    <section className="user-edit-content-container">
                        <h1>
                            Profile Settings
                        ...
                        <form className="user-edit-form" onSubmit={this.handleSubmit.bind(this)} onKeyPress={(e) => {
                            ...
                            <div className="user-edit-form-section">
                                <label className="user-edit-form-label">
                                    <b>Display Name</b>
                                    <span>Spaces and special characters are fine.</span>
                                </label>
                                <input type="text"
                                    className="user-edit-display-name-input"
                            ...
                            <div className="user-edit-form-section">
                                ...
                                <textarea
                                    className="user-edit-biography-input"
                                    value={`${this.state.biography}`}
                                    onChange={(e) => this.handleBiography(e)}
